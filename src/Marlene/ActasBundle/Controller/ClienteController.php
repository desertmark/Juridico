...
class ClienteController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('MarleneActasBundle:Cliente')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("MarleneActasBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MarleneActasBundle:Cliente')->find($id);
     ...
     * @Method("PUT")
     * @Template("MarleneActasBundle:Cliente:edit.html.twig")
     */
